...
export default class VerticalLineShell extends React.Component {
	constructor(props){
		super(props);
		this.refArray = [];
		this.newArr = [vlsRefs.map( (item, i) => {
            ...
            return (<VerticalLine className="blue" setRef={ (div) => this[ref] = div } key={i} /> )
        } )]
